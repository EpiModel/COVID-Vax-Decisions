...
param <- param.net(
  ...
  icr.rate = 1 / 3.5,
  ich.rate = 1 / 3, 
  hr.rate = 1 / 10, # from https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7899024/
  rs.rate = 1 / 270, # from https://www.cdc.gov/coronavirus/2019-ncov/science/science-briefs/vaccine-induced-immunity.html 
  pcr.sens = 0.8, 
  dx.rate.sympt = 0.1, 
  dx.rate.other = 0.01,
  allow.rescreen = TRUE, 
  ...
  misc.nudge.prob.1 = c(NA, NA, .17, .17, .12), # for dose 1; by age group; calibrated
  misc.nudge.prob.2 = c(NA, NA, .75, .43, .32), # for dose 2; by age group; calibrated
