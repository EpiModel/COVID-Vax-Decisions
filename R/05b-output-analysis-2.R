...
((g_dose_cont_old + g_dose_cont_old_2) / (g_inc_cont_old + g_inc_cont_old_2) / (g_death_cont_old + g_death_cont_old_2)) + plot_annotation(tag_levels = list(c("A1", "A2", "B1", "B2", "C1", "C2")))
